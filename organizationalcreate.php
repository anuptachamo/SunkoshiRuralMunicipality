...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($dropdown_err) && empty($no_of_staffs_err) && empty($establish_date_err) && empty($description_err) && empty($address_err) && empty($contact_err)){
        ...
        $sql = "INSERT INTO organizational (name, dropdown, no_of_staffs, establish_date, description, address, contact) VALUES (?, ?, ?, ?, ?, ?, ?)";
 
        if($stmt = $mysqli->prepare($sql)){
            // Bind variables to the prepared statement as parameters
            $stmt->bind_param("sssssss", $param_name, $param_dropdown, $param_no_of_staffs, $param_establish_date, $param_description, $param_address, $param_contact);
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please fill this form and submit to add Organizational Data record to the database.</p>
